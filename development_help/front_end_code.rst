...
'Bundle modules' are specified inside the static/js directory of a Django app - e.g. 'bundle modules' in taskconnect are under ``taskconnect/taskconnect/static/js/bundle_modules``. Here is a simple example of a bundle_module::
